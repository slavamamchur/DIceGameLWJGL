...
package com.sadgames.vulkan.newclass.gl_api;
...
public class GLVersion {
	...
	private void extractVersion (String patternString, String versionString) {
		...
		if (found) {
			...
			System.out.println("Invalid version string: " + versionString);
			majorVersion = 2;
			minorVersion = 0;
			releaseVersion = 0;
		}
	...
	private int parseInt (String v, int defaultValue) {
		try {
			...
			System.out.println("Error parsing number: " + v +", assuming: " + defaultValue);
			return defaultValue;
		}
	}
